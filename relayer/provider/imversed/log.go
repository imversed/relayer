...
func (cc *ImversedProvider) LogFailedTx(res *provider.RelayerTxResponse, err error, msgs []provider.RelayerMessage) {
	if err != nil {
		cc.log.Error(
...
func (cc *ImversedProvider) LogSuccessTx(res *sdk.TxResponse, msgs []provider.RelayerMessage) {
	feesField := zap.Skip()
